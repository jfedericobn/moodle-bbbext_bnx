...
$string['bnx:earlyjoinaccess'] = 'Join a BigBlueButton room ahead of the scheduled opening time';
...
$string['check_bnreminders_conflict'] = 'Legacy BN Reminders conflict';
$string['check_bnreminders_conflict_action'] = 'Open BigBlueButton extension management';
$string['check_bnreminders_conflict_enable_error'] = 'BNX and legacy BN Reminders must not operate together. Disable or remove BN Reminders in Plugins overview, then enable BNX.';
$string['check_bnreminders_conflict_ok'] = 'No conflict with the legacy BN Reminders plugin.';
$string['check_bnreminders_conflict_ok_details'] = 'The legacy BN Reminders plugin is not installed or is disabled, so BNX can run normally.';
$string['check_bnreminders_conflict_warning'] = 'BNX cannot run while legacy BN Reminders is installed and enabled.';
$string['check_bnreminders_conflict_warning_details'] = 'BNX and legacy BN Reminders must not operate together. Migrate any legacy data, then disable or remove BN Reminders in Plugins overview before enabling BNX.';
$string['check_bnreminders_migration_pending'] = 'Legacy BN Reminders migration pending';
$string['check_bnreminders_migration_pending_ok'] = 'No BN Reminders migration is pending.';
$string['check_bnreminders_migration_pending_ok_details'] = 'All applicable legacy BN Reminders data has been copied into BNX.';
$string['check_bnreminders_migration_pending_warning'] = 'Legacy BN Reminders data still needs to be migrated.';
$string['check_bnreminders_migration_pending_warning_details'] = 'Legacy BN Reminders data remains unmigrated. Run: php public/mod/bigbluebuttonbn/extension/bnx/cli/migrate_bnreminders.php.';
...
$string['earlyaccess_default'] = 'Default early access state';
$string['earlyaccess_default_desc'] = 'If enabled, users with the appropriate capability can join sessions before the scheduled opening time by default.';
$string['earlyaccess_editable'] = 'Allow teachers to change the default early access setting per activity';
$string['earlyaccess_editable_desc'] = 'If enabled, teachers can override the default early access behaviour in activity settings.';
...
$string['maxfiles'] = 'Maximum number of presentation files';
$string['maxfiles_desc'] = 'The maximum number of presentation files that can be uploaded to each BigBlueButton activity.';
...
$string['mod_form_earlyaccess'] = 'Allow room access before opening time';
$string['mod_form_earlyaccess_error'] = 'Set an opening time to enable early access.';
$string['mod_form_earlyaccess_header'] = 'Early Access +';
...
$string['privacy:metadata:bbbext_bnx_reminders_guests:isenabled'] = 'Whether the guest is currently subscribed to receive reminders.';
$string['privacy:metadata:bbbext_bnx_reminders_guests:userfrom'] = 'The user who added the guest email for reminders.';
...
$string['section_earlyaccess_desc'] = 'Allow authorised users to enter a room before its scheduled opening time.';
...
$string['section_preuploads_heading'] = 'Presentation content +';
...
$string['view_early_message'] = 'You have early access to prepare this room';
